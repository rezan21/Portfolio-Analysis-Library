...
class TestPortfolioClass(unittest.TestCase):
    ...
    def test_calculate_annual_sharpe_explicit(self):
        ffme_portfolio = main.Portfolio(ffme, 12)
    ...
    def test_calculate_annual_sharpe_implicit(self):
        ffme_portfolio = main.Portfolio(ffme, 12)
        desired = Desired.FFME_ANN_SHARPE
        ffme_portfolio.get_annual_sharpe()
        actual = ffme_portfolio.annual_sharpe.to_dict()
    ...
    def test_calculate_annual_sharpe_3pct_implicit(self):
        ffme_portfolio = main.Portfolio(ffme, 12)
    ...
    def test_calculate_max_drawdown_explicit(self):
        ffme_portfolio = main.Portfolio(ffme, 12)
    ...
    def test_calculate_max_drawdown_implicit(self):
        ffme_portfolio = main.Portfolio(ffme, 12)
        desired = Desired.FFME_MAX_DRAWDOWN
        ffme_portfolio.get_max_drawdown(A=1000)
        actual = ffme_portfolio.drawdown["max_drawdown"].to_dict()
